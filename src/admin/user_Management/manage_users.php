...
if ($search !== '') {
  $sql .= " AND (name LIKE :s OR email LIKE :s OR phone_no LIKE :s OR customer_id = :idExact)";
  $params[':s'] = "%$search%";
      ...
      <tbody>
        ...
        <?php else: foreach ($users as $u): ?>
          <tr>
            ...
            <td id="status-badge-<?= $u['customer_id'] ?>">
              <?php
            ...
            <td>
              <a class="action-sm action-view" href="view_users.php?user_id=<?= $u['customer_id'] ?>">View</a>
              <?php
                $toggleTarget = $u['status'] === 'Active' ? 'Suspended' : 'Active';
                $toggleLabel = $u['status'] === 'Active' ? 'Suspend' : 'Activate';
              ?>
              <a href="#" data-id="<?= $u['customer_id'] ?>" data-target="<?= $toggleTarget ?>" class="action-sm action-toggle toggle-status"><?= $toggleLabel ?></a>
            </td>
          </tr>
