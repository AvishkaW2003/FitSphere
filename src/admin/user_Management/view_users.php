...
// ✅ FIX: Changed 'customers' to 'users' and 'customer_id' to 'user_id'
...
<div class="form-card">
    <div class="user-card">
        ...
        <h3><?= htmlspecialchars($user['name']) ?> <small class="text-muted">#<?= $user['user_id'] ?></small></h3>
...
<div >
    ...
    <div>
      ...
      <div class="mt-3 d-flex justify-content-between">
        ...
        <button class="submit-btn" type="submit" onclick="">Save Changes</button>
      </div>
    </form>
</div>
